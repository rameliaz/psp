...
1. Kenapa validitas adalah sifat **tafsiran atas skor**, bukan sifat dari skala
2. Bagaimana tiga "jenis validitas" berubah menjadi **satu konsep dengan lima sumber bukti**
3. Lima sumber bukti validitas
4. *Construct underrepresentation* dan *construct-irrelevant variance*
5. Kenapa menaikkan $\alpha$ terus-menerus justru bisa **menurunkan** validitas
...
![](libs/rel_val.JPG){.nostretch fig-align="center" width="90%"}

::: aside
Ilustrasi yang umum muncul di buku ajar pengukuran psikologi.
:::
...
1. **Terikat pada tujuan.** Skala yang tafsirannya mendukung kesimpulan penelitian belum tentu sesuai untuk seleksi kerja atau penegakan diagnosis.
...
3. **Tidak pernah selesai.** Bukti validitas bisa bertambah, dan bisa juga berkurang ketika muncul temuan yang bertentangan.
...
# Dari 3️⃣ jenis menjadi 1️⃣ konsep {background-color="#14497F" .center}
...
* [**Cronbach & Meehl (1955)**](https://psycnet.apa.org/record/1956-03730-001) memperkenalkan validitas konstruk dan gagasan *nomological network*: makna sebuah konstruk terletak pada jaringan hubungannya dengan konstruk lain.

* [**Loevinger (1957)**](https://journals.sagepub.com/doi/abs/10.2466/pr0.1957.3.3.635) berargumen lebih jauh: validitas konstruk **bukan sekedar salah satu jenis validitas**, melainkan keseluruhan validitas itu sendiri.

* **Messick ([1989](https://journals.sagepub.com/doi/abs/10.3102/0013189x018002005), [1995](https://psycnet.apa.org/record/1996-10004-001))** menyatukannya: validitas adalah **satu penilaian menyeluruh** atas sejauh mana bukti dan teori mendukung kesimpulan serta tindakan yang diambil dari skor.

* [***The Standards* (2014)**](https://www.testingstandards.net/) menurunkannya menjadi bentuk yang praktis: bukan "jenis validitas", melainkan **sumber-sumber bukti** yang semuanya menopang satu tafsiran.
...
# 5️⃣ sumber bukti {background-color="#14497F" .center}
...
# Bukti 1️⃣: isi tes {background-color="#14497F" .center}
...
* Prosedur bakunya disebut ***Content Validity Index*** ([Lynn, 1986](https://www.ovid.com/jnls/nursingresearchonline/abstract/00006199-198611000-00017~determination-and-quantification-of-content-validity?an=00006199-198611000-00017&redirectionsource=fulltextview); [Polit & Beck, 2006](https://onlinelibrary.wiley.com/doi/abs/10.1002/nur.20147)).
...
# Bukti 2️⃣: proses respons {background-color="#14497F" .center}
...
* Ingat Pertemuan 2: [Nisbett & Wilson (1977)](https://psycnet.apa.org/record/1978-00295-001) menunjukkan bahwa orang sering tidak punya akses pada proses mentalnya sendiri.
...
::: aside
[Willis (2005)](https://www.researchgate.net/profile/Gordon-Willis/publication/228902728_The_use_of_cognitive_interviewing_to_evaluate_translated_survey_questions_Lessons_learned/links/00463516f06b5a0882000000/The-use-of-cognitive-interviewing-to-evaluate-translated-survey-questions-Lessons-learned.pdf).
:::
...
# Bukti 3️⃣: struktur internal {background-color="#14497F" .center}
...
# Bukti 4️⃣: hubungan dengan variabel lain {background-color="#14497F" .center}
...
* [**Campbell & Fiske (1959)**](https://psycnet.apa.org/record/1960-00103-001) mengusulkan cara memeriksa keduanya sekaligus: ukur beberapa konstruk dengan beberapa metode, lalu bandingkan pola korelasinya.
...
* Ingat temuan [Fried (2017)](https://www.sciencedirect.com/science/article/pii/S016503271631312X) dari Pertemuan 1: tujuh skala depresi memuat 52 gejala berbeda.
...
# Bukti 5️⃣: konsekuensi penggunaan {background-color="#14497F" .center}

## Gagasannya

::: {.incremental}

* [Messick (1995)](https://psycnet.apa.org/record/1996-10004-001) berargumen bahwa **akibat dari penggunaan skor** juga merupakan bagian dari pertimbangan validitas.
...
* [**Borsboom, Mellenbergh, & van Heerden (2004)**](https://d1wqtxts1xzle7.cloudfront.net/53409598/borsboomValidity2004-libre.pdf?1496798337=&response-content-disposition=inline%3B+filename%3DThe_Concept_of_Validity_Netherlands_Auti.pdf&Expires=1786119942&Signature=dCjv8LvEpx8-NoFGY8VvpfNZ9Ihs0zOxFcoDaCaYUbeh3q9wxglMCO4cHlp4F-rgy-2bMK3LuO11MD0rrpTLGguyLq5LEsBkmeXtwf-mmH~PFZkGhLChkhEMzDsHlWOfRTgeacsRbq9TbmQ4-sLVw~FWSC8VuiAzopPUC93GIPtKXsD83oJJpofW41kN2Si5HjkBGYORa8JProTIOpI3mUXPrUV8S05uxTspWoeqo3sYIORyG3PV8CS0atP2GVIuk1foGmrcdmHy4lpkR3MW11s6nxnC65l8r2pAeIO1Sy2hJ0UpEa5mTWqNHOzGRrFrpPQghwzis2e7NeeOHt3Ctw__&Key-Pair-Id=APKAJLOHF5GGSLRBV4ZA) menilai definisi Messick terlalu luas dan mencampurkan terlalu banyak hal.
...
* [**Loevinger (1954)**](https://psycnet.apa.org/record/1955-03299-001) menunjukkan bahwa setelah titik tertentu, menaikkan konsistensi internal justru **menurunkan** validitas.
...
# Rencana uji validitas untuk proyek UAS Anda {background-color="#14497F" .center}
...
# Menutup paruh pertama MK PSP {background-color="#14497F" .center}
...
3. CTT merapikan asumsi ini menjadi $X = T + E$.
4. Format respons menentukan asumsi mana yang Anda pakai.
5. Format lain melepaskan asumsi yang berbeda, dengan risikonya masing-masing.
...
::: {.callout-note appearance="simple"}
Tujuh kesimpulan ini dapat dirangkum menjadi satu kalimat: **Anda perlu tahu asumsi apa yang sedang Anda pakai ketika membuat skala dan melakukan pengukuran, dan apa akibatnya kalau asumsi itu salah.**
:::
...
::: {.callout-tip appearance="simple"}
Cara belajar yang mungkin membantu: ambil satu skala apa pun yang Anda temukan, lalu jawab sendiri tujuh pertanyaan sesuai tujuh pertemuan di atas.
:::
...
* **Pertemuan 11 dan seterusnya** — bimbingan langsung bersama Bu Dian, di Ruang 303, dengan hari dan jam yang berbeda. Periksa kembali [jadwalnya](https://rameliaz.github.io/psp/#rencana-pertemuan).

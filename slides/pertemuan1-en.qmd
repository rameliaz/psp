...
* None of them is a **statistical** problem. Not one is solved by choosing a fancier test.
...
* **c. 2200 BCE, China** — civil service examinations for selecting officials (DuBois, in Barnette, 1976).

* **Proverbs 11:1** — *"A false balance is an abomination to the Lord, but a just weight is a delight."* A dishonest scale was a moral matter.

* **Aristotle** refers to officials charged with checking weights and measures.

* **7th century** — Muslim taxation based on the "weight of seven" (Wright, 1999).
...
Every entry is about **fairness**, not about scientific accuracy. Measurement has been an instrument of power and distribution from the very beginning — something that becomes relevant again when we discuss test bias and the use of psychological tests for selection.
:::
...
* Alder (2002) notes that as late as the 1700s, concealing observational discrepancies "were not only common, they were considered a savant's prerogative."

* **The conceptual shift is enormous**: from error as a personal failing → to error as a systematic property of the measurement process that can be modelled.

* Without that shift, there would be **no such thing** as *Classical Test Theory*. We take it up in Session 3.
...
* **1660s, John Graunt** compiled birth and death rates from christening and burial records in Hampshire, England. He averaged them to capture a "true" value he believed lay hidden behind the unpredictable events of any given year.
...
Bernoulli's comparison describes what we will later call ***random error***, and exactly why reliability can be raised simply by **adding items**. We return to it in Session 6.
:::
...
Many early contributors to psychometrics worked within a **eugenics** framework. We still use their statistical tools; we are **not obliged to inherit** the political assumptions behind them. Knowing this history is part of being critical about the instruments we use.
:::
...
* The **Commission of the British Association for the Advancement of Science** (appointed 1932, final report 1940) concluded that **fundamental measurement of psychological variables was impossible** — because sensory perceptions cannot be ordered or added the way length and mass can.
...
::: {.callout-tip}
#### Not just trivia
The scientific legitimacy of psychological measurement was **never simply given**. It had to be **argued for**, against serious and reasonable objections.
:::
...
* Which means the objection did **not disappear** merely because Stevens won sociologically.

* It is still there, and some scholars argue it was never actually answered. We meet its modern version in a moment.
...
* This definition is **very permissive** — deliberately so. It was built so that psychological measurement would fit inside it.

* The consequence: almost anything can be called measurement, as long as there is a rule.

:::

## Duncan's objection

> [Stevens's definition] is incomplete in the same way that "playing the piano is striking the keys of the instrument according to some pattern" is incomplete. Measurement is not only the assignment of numerals. It is also the assignment of numerals **in such a way as to correspond to different degrees of a quality** . . . or property of some object or event.
>
> — Duncan (1984, p. 126)
...
* **Joel Michell** (1997, 2000) argues that Stevens's definition is not merely incomplete — it **obscures the real question**.
...
We derive this properly in Session 6.
:::
...
* Many findings in psychology fail to replicate independently — partly attributable to **imprecise measurement**, combined with researcher degrees of freedom in data analysis.
...
* Most of those symptoms appear in only **one** of the scales.
...
Remember this when you design your pilot study in Session 12.
:::
...
* Form groups of **five** — this will be **your project group for the whole semester**.

* Choose **one psychological construct** your group would like to measure. It need not be final; we sharpen it in Session 9.

* Discuss the questions on the next slide (**20 minutes**), then each group presents its answers in **3 minutes**.

:::

::: {.notes}
Split students into groups of five. Circulate between groups rather than staying at the front.
If a group stalls on question 2, prompt with: "if the total score goes down, what has changed
about the person?" Leave at least 20 minutes for presentations and the wrap-up.
:::
...
1. **What is your construct called, and what is *not* part of it?** Name one neighbouring construct it must be distinguished from.

2. **Scale, index, or emergent variable?** Does your construct **cause** the answers to its items, or do the items **constitute** the construct? What is your argument?

3. **What would "zero" mean on your construct?** Is there anyone who genuinely has none of this attribute? If not, what follows for how you report scores?

4. **Does an instrument already exist?** If it does — why build another? If it does not — why do you think nobody has?
...
Stating what your construct **excludes** will do more for the quality of your scale than stating what it includes. We will call this the **construct boundary** in Session 9.
:::
...
::: {.callout-tip}
#### Preparation
Read **DeVellis & Thorpe (2022), Chapter 1**. If you have time, look at Chapters 1 and 2 of Petersen (linked on the Reading slide).
:::

...
1. What are we actually doing when we "measure" something?
2. A short history: measurement was born of social need, not of science
3. Why the definition of "measurement" is still contested today
4. Levels of measurement (Stevens) — and the problem they leave behind
5. Why psychology is forced to measure **indirectly**
6. Scales, indices, and emergent variables — not every set of items is a scale
7. What does bad measurement actually cost?
...
::: {.closing-note}
These slides were made using {{< fa brands r-project >}} and [Quarto](https://quarto.org/), with a template from [UNAIR Theme](https://github.com/rameliaz/quarto-unair-theme).
:::

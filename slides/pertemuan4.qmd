...
* [Krosnick (1991)](https://onlinelibrary.wiley.com/doi/abs/10.1002/acp.2350050305) menyebut pola ini ***satisficing***: responden memberi jawaban yang "cukup memadai", bukan jawaban yang paling akurat.
...
**Dua masalah sekaligus.** *Pertama*, "Agak" dan "Kurang" sulit dibedakan bahkan dalam keadaan terbaik. *Kedua*, kalau dibaca dari kiri, "Agak Membantu" tampak lebih tinggi daripada "Kurang Membantu"; kalau dibaca dari kanan, urutannya justru terbalik.
:::
...
* Secara logika, menyetujui item 1 seharusnya berarti menyetujui item 2 juga.

* Tapi, bisa jadi ada partisipan yang percaya bahwa aktif di ormawa dapat **sekaligus** mengorbankan prestasi akademik, sehingga menyimpang dari pola urutan Guttman.

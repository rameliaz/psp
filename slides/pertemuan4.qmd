...
1. Memilih format respons: Apa yang harus diperhatikan?
2. **Likert**: asal-usulnya, dan 4️⃣ keputusan yang harus Anda ambil
3. **Semantic Differential**: kapan pasangan kata sifat lebih tepat digunakan daripada pernyataan
4. **Guttman**: ketika item memang berjenjang secara logis dan kenapa format ini jarang berhasil
5. Membandingkan format Likert, Semantic Differential, dan Guttman
6. Pertanyaan penutup: **memilih format respons berkaitan dengan asumsi pengukuran yang mana?**


# Memilih format respon {background-color="#14497F" .center}
...
* Diperkenalkan [**Rensis Likert (1932)**](https://psycnet.apa.org/record/1933-01885-001) dalam disertasinya, *A technique for the measurement of attitudes*.

* Gagasan intinya bukan pada opsi "Sangat Setuju sampai Sangat Tidak Setuju", melainkan pada ***summated ratings***. 
  + Artinya, sekumpulan item yang direspons dengan skala berjenjang, lalu **dijumlahkan** menjadi satu skor.

* Jadi yang disebut "skala" oleh Likert adalah **kumpulan itemnya** (yang kemudian dijumlahkan skornya), bukan opsi responsnya.
...
* **Empat pilihan atau kurang** menekan variasi antar-partisipan dan menurunkan presisi. 
...
Pertama, **kemampuan partisipan membedakan**. Kalau partisipan tidak sanggup membedakan tujuh pilihan respon, menyediakan tujuh pilihan hanya akan menambah *noise*.
...
**Memaksa** partisipan memberikan pilihan, walaupun berbeda dengan kondisi mereka sebenarnya.
...
* Kalau setiap item punya pilihan di tengah, sebagian partisipan akan belajar bahwa mereka **selalu bisa memilih pilihan tengah** dan menyelesaikan kuesioner lebih cepat.
...
* [Krosnick (1991)](https://onlinelibrary.wiley.com/doi/abs/10.1002/acp.2350050305) menyebut pola ini ***satisficing***: partisipan memberi jawaban yang "cukup memadai", bukan jawaban yang paling akurat.
...
* Alasannya sederhana: kalau hanya ujungnya yang diberi label, tiap partisipan menafsirkan sendiri arti titik-titik di antaranya.
...
::: {.callout-tip}
#### Penting diketahui
*Anchor* persetujuan mendorong partisipan untuk sekadar mengiyakan. [Weijters dkk. (2010)](https://psycnet.apa.org/record/2010-04293-009) memperkuat hal ini dengan menunjukkan bahwa format skala ikut menentukan *response style* yang muncul.
:::
...
Uji pasangan kata sifatnya pada beberapa calon partisipan sebelum uji coba. Tanyakan satu hal sederhana: *"Menurut Anda, apa lawan kata dari ini?"* Kalau jawabannya bukan kata yang Anda pasangkan, pasangan kata tsb. perlu diganti.
:::
...
* Pada panel kanan, 3️⃣ partisipan menyimpang: ada yang menyetujui item yang sulit tetapi menolak item yang lebih mudah.
...
* **Likert** mengasumsikan jarak antar-kategori setara, semua partisipan memaknai jangkar dengan cara yang sama, dan semua item berbobot sama.

* **Semantic Differential** mengasumsikan pasangan kata sifatnya benar-benar bipolar, dan maknanya sama bagi semua partisipan.
...
Tiga format respons berikut punya masalah.
...
::: {.notes}
Jawaban yang diharapkan — A: jangkar tidak seimbang, tiga positif satu negatif, sehingga sebaran skor terdorong ke atas. 
B: kuantifier tanpa rujukan waktu; "sering" berbeda artinya bagi tiap orang.
C: item ganda (kompeten dan peduli adalah dua hal), partisipan yang setuju pada satu bagian saja
tidak punya jawaban yang benar. 

Kalau waktu mepet, cukup bahas A dan C.
:::
...
1. **Format respons bukan soal kebiasaan atau selera pembuat skala.** Setiap format punya asumsinya sendiri, sehingga memilih format = memilih asumsi.
...
4. **Pilihan tengah punya kelebihan dan kekurangan.** Tidak ada format yang otomatis lebih baik, serta "netral", "ragu-ragu", serta "kurang setuju" bukan hal yang sama.

5. **Semantic Differential** memerlukan pasangan kata sifat yang benar-benar berlawanan dalam bahasa Indonesia.
...
* **Thurstone** — item diberi bobot berbeda oleh panel ahli, sehingga tidak diperlakukan setara.
* ***Situational Judgement Test*** — yang diukur adalah penilaian dalam situasi konkret.
* ***Forced-choice*** — digunakan ketika *social desirability* menjadi masalah utama, dan partisipan dipaksa memilih di antara dua hal yang sama-sama menarik.

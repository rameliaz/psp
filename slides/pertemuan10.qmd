...
1. Menyusun **kisi-kisi**: berapa item untuk tiap aspek, dan kenapa perlu sejumlah itu
2. Kaidah menulis item, dengan contoh yang salah dan perbaikannya
3. **Item *unfavorable***: bagaimana bukti empiriknya, dan kapan sebaiknya dipakai
4. Menetapkan **format respons** untuk seluruh skala
5. Merakit kuesionernya: pengantar, petunjuk, tata letak
6. *Workshop* dan saling menelaah antar-kelompok


# Spesifikasi konstruk menjadi item {background-color="#14497F" .center}
...
Kalau kelompok Anda belum punya uraian spesifikasi konstruk, kerjakan itu lebih dulu hari ini. Menulis item tanpa definisi konstruk akan membuat Anda kerja dua kali.
:::

# Kisi-kisi {background-color="#14497F" .center}

## Apa yang dicakup oleh kisi-kisi (*blueprint*)
...
Tanpa kisi-kisi, aspek yang paling gampang dibayangkan mendapat sepuluh item, sementara aspek yang sulit hanya kebagian dua.
:::
...
Menambah item terus-menerus membuat performa skala menjadi semakin jelek, dan menambah beban partisipann.
:::
...
* Kalau semua item Anda menggambarkan tingkat yang ekstrim, partisipan dengan tingkat sedang tidak akan bisa dibedakan satu sama lain.
...
* Item ganda (*double-barrelled*) memuat dua gagasan sekaligus, sehingga partisipan yang setuju pada satu bagian saja tidak punya jawaban yang benar.
...
* Item yang panjang memaksa partisipan mengingat awal kalimat saat membaca bagian akhirnya.
...
::: {.callout-note}
DeVellis menyarankan tingkat keterbacaan setara kelas 5–7 untuk instrumen yang dipakai pada masyarakat umum. Untuk partisipan mahasiswa, Anda punya sedikit kelonggaran, tetapi kalimat pendek tetap lebih baik.
:::
...
* Item juga sebaiknya tidak membuat partisipan merasa dihakimi, terutama untuk konstruk yang rawan *social desirability* (Pertemuan 2).
...
* Gagasannya berasal dari [Likert (1932)](https://psycnet.apa.org/record/1933-01885-001): untuk menekan kecenderungan partisipan menyetujui apa saja, separuh item dibuat searah dan separuh berlawanan arah.

* Kalau partisipan hanya mengiyakan, polanya akan terlihat: ia menyetujui item yang searah **dan** yang berlawanan sekaligus.
...
* Item terbalik sering **membentuk faktornya sendiri** pada analisis faktor. Yang muncul di situ adalah cara penulisannya.
...
* Performa partisipan menurun sekitar **12 menit** setelah mulai mengisi.
...
Untuk konstruk yang sifatnya memang negatif, seperti kecemasan, depresi, kalimat bernada negatif adalah bentuk yang terbaik. Memaksakan item *unfavorable* di sini justru membuat kalimatnya berbelit.
:::
...
* **Judul** — mencerminkan isi, singkat, dan tidak membuat partisipan segan mengisi.
...
* **Beri nomor** dan **judul bagian** supaya partisipan tahu sudah sampai mana.
...
::: {.callout-tip}
#### Data demografis
Letakkan di bagian **akhir**, kecuali kalau diperlukan untuk menyaring partisipan di awal. Pertanyaan demografis di awal membuat sebagian partisipan merasa diidentifikasi sebelum mereka tahu isi kuesionernya.
:::
...
partisipan dengan tingkat sedang, lalu tanya item mana yang bisa membedakannya.
:::

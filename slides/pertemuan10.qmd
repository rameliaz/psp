...
* **Item bernada terbalik**: apa kata datanya, dan kapan sebaiknya dipakai
...
* Dokumen spesifikasi konstruk dari Pertemuan 9: definisi, batas, estimand, dimensi, aspek, dan indikator.

* Hari ini indikator itu berubah menjadi **item**, dan item disusun menjadi **kuesioner**.

* Ini pertemuan terakhir bersama saya sebelum Anda melanjutkan bersama Dian.
...
::: {.callout-warning}
Kalau kelompok Anda belum punya dokumen spesifikasi konstruk, kerjakan itu lebih dulu hari ini. Menulis item tanpa definisi konstruk hanya akan menghasilkan pekerjaan yang harus diulang.
:::

# Kisi-kisi {background-color="#14497F" .center}

## Apa yang dilakukan kisi-kisi
...
* Patokan yang lazim: tulislah **dua sampai tiga kali** jumlah item yang Anda targetkan.
...
Menambah item terus-menerus punya hasil yang makin kecil, dan menambah beban responden.
:::
...
* Kalau semua item Anda menggambarkan tingkat yang parah, responden dengan tingkat sedang tidak akan terbedakan satu sama lain.
...
| "Saya introver, jadi saya menghindari keramaian." | "Saya menghindari acara yang ramai." |
...
# Item bernada terbalik {background-color="#14497F" .center}
...
::: {.callout-note}
Sampai di sini gagasannya masuk akal. Persoalannya muncul pada pelaksanaannya.
:::
...
::: aside
Ringkasan dari Chyung, Barkin, & Shamsy (2018); lihat juga Weijters, Baumgartner, & Schillewaert (2013).
:::

## Dan responden berhenti memperhatikan
...
::: {.callout-tip}
#### Kalau tetap dipakai
* Letakkan item terbalik **di bagian awal** kuesioner.
* Pastikan item terbalik benar-benar **lawan yang setara**, bukan sekadar penambahan kata "tidak".
* **Periksa pengaruhnya** saat analisis: lihat apakah item terbalik mengelompok sendiri.
:::
...
Untuk konstruk yang sifatnya memang negatif — kecemasan, depresi — kalimat bernada negatif adalah bentuk yang paling wajar. Memaksakan item terbalik di sini justru membuat kalimatnya berbelit.
:::

# Format respons {background-color="#14497F" .center}

## Keputusan yang sudah Anda pelajari

Dari Pertemuan 4, tetapkan sekarang untuk **seluruh skala**:

::: {.incremental}

* **Berapa pilihan.** Wilayah 5–7 masuk akal untuk sebagian besar keperluan.
* **Titik tengah atau tidak.** Pakai kalau posisi tengah memang bermakna untuk konstruk Anda.
...
::: {.callout-note}
#### Soal titik tengah
Chyung dkk. (2017) menyarankan pertanyaannya diubah: bukan *"perlu titik tengah atau tidak"*, melainkan *"kapan titik tengah itu tepat"*. Titik tengah tepat kalau ia benar-benar posisi tengah, bukan tempat responden menghindar.

Kalau yang Anda antisipasi adalah ketidaktahuan, sediakan pilihan terpisah seperti "tidak tahu", jangan campur dengan titik tengah.
:::
...
* Pershing & Pershing (2001) memeriksa 50 formulir evaluasi pelatihan yang dipakai di sebuah sekolah kedokteran ternama.
...
::: {.callout-warning}
Tampilan yang berantakan menurunkan kesungguhan responden, dan itu langsung berpengaruh pada reliabilitas serta validitas skor Anda. Ini bukan soal estetika.
:::
...
* **40 menit** — Tulis itemnya. Kejar jumlah pada kolom "item ditulis", bukan kolom target akhir.
...
* Anda melanjutkan bersama **Dian Kartika Amelia Arbi, M.Psi., psikolog**.

* **Senin, pukul 13.00 WIB, Ruang 303** — hari, jam, dan tempatnya berbeda dari yang selama ini. Periksa lagi jadwalnya.

* Materinya: review ahli dan perhitungan *Content Validity Index*.

* Bawa dokumen spesifikasi konstruk, kisi-kisi, dan daftar item kelompok Anda.
...
::: {.callout-tip}
#### Persiapan
Baca **Polit & Beck (2006)** kalau sempat. Yang lebih penting: pastikan daftar item kelompok Anda sudah rapi, karena itulah yang akan dinilai panel.
:::

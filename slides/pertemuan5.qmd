...
1. **Kumpulkan banyak pernyataan** tentang objek sikap, yang biasanya puluhan hingga ratusan.

2. **Minta anggota panel** menempatkan tiap pernyataan ke dalam 11 kategori, dari paling bertentangan sampai paling mendukung konstruk. Anggota panel **tidak** diminta pendapat pribadinya; mereka diminta menilai **posisi pernyataannya** di garis kontinum level atribut ($\theta$).
...
5. **Pilih pernyataan yang tersisa** sedemikian rupa sehingga nilai skalanya **tersebar merata** di sepanjang kontinum level atribut ($\theta$).
...
Pada Likert, **informasi ada pada derajat jawaban**. Pada Thurstone, informasi ada pada **item mana yang disetujui**. Pilihan jawabannya sendiri hanya ya/tidak.
:::
...
* **Untuk proyek pengembangan skala Anda.** Di Pertemuan 11, Anda akan meminta panel ahli menilai relevansi tiap item, lalu menghitung *Content Validity Index*.
...
* **Konteks yang konkret.** partisipan tidak diminta menggeneralisasi tentang dirinya, melainkan menanggapi situasi tertentu. Ini menghindari sebagian masalah akses introspektif dari Pertemuan 2.
...
## Ketiganya tidak realistis diterapkan untuk UAS

::: {.incremental}

* **Thurstone** — masih realistis. 

* **SJT** — tidak realistis untuk UAS ini. Menulis skenario yang baik dan menyusun kunci jawabannya adalah penelitian empirik tersendiri.
...
2. **Kalibrasi nilai skala Thurstone adalah asal mula parameter kesulitan dalam IRT**, dan prosedur jurinya adalah menginspirasi prosedur penilaian *reviewer* dalam proses penghitungan CVI.

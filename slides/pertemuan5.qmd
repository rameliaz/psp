...
1. 3️⃣ asumsi pengukuran yang selama ini diterima begitu saja
2. **Thurstone**: item yang sudah dikalibrasi lebih dulu oleh panel
3. ***Situational Judgement Test***: mengukur penilaian atas situasi, bukan pernyataan tentang diri sendiri (*self-report*)
4. ***Forced-choice***: partisipan dipaksa memilih, dan skornya menjadi **ipsatif**
5. Kenapa data ipsatif berlawanan dengan hampir semua asumsi yang kita pelajari di Pertemuan 3

...
* Tiga hal yang selama ini kita anggap wajar — dan format yang melepaskannya
* **Thurstone**: item yang sudah dikalibrasi lebih dulu oleh panel juri
* ***Situational Judgement Test***: mengukur penilaian, bukan pernyataan tentang diri
* ***Forced-choice***: ketika responden dipaksa memilih, dan skornya menjadi **ipsatif**
* Kenapa data ipsatif merusak hampir semua yang kita pelajari di Pertemuan 3
* Apa yang realistis untuk proyek Anda semester ini
...
# Tiga hal yang selama ini kita anggap wajar {background-color="#14497F" .center}

## Yang tersembunyi di balik format Pertemuan 4

Ketika kita memakai skala Likert, kita diam-diam menerima tiga hal:
...
3. **Setiap item dijawab secara terpisah.** Menyetujui satu item tidak memaksa Anda menolak item lain.
...
Tiga format yang masing-masing **melepaskan satu** di antara ketiganya — dan membayar harganya.
:::

## Peta hari ini

| Format | Yang dilepaskan | Yang diperoleh |
|--------|-----------------|----------------|
| **Thurstone** | Bobot item yang sama | Item terkalibrasi di sepanjang kontinum |
| **SJT** | Pernyataan diri yang abstrak | Konteks dan penilaian yang konkret |
| ***Forced-choice*** | Kebebasan menjawab tiap item | Perlindungan dari *social desirability* |

. . .

::: {.callout-warning}
Ketiganya menarik secara konseptual. Ketiganya juga **jauh lebih sulit dikerjakan** daripada Likert, dan dua di antaranya merusak asumsi yang kita bangun di Pertemuan 3. Kita akan lihat persis di mana.
:::
...
* Skala Thurstone bekerja persis seperti itu: tiap item "disetel" untuk merespons level atribut tertentu.
...
::: {.callout-tip}
Bandingkan dengan Likert, di mana semua item pada dasarnya adalah **detektor yang sama** dan yang berbeda hanya derajat jawabannya.
:::
...
2. **Minta panel juri** menempatkan tiap pernyataan ke dalam 11 tumpukan, dari paling menentang sampai paling mendukung. Juri **tidak** diminta pendapat pribadinya; mereka diminta menilai **posisi pernyataannya**.

3. **Hitung median** penilaian juri untuk tiap pernyataan. Itulah **nilai skala** (*scale value*) pernyataan tersebut.

4. **Hitung sebaran penilaian juri** (rentang antar-kuartil). Pernyataan yang juri-jurinya tidak sepakat berarti **ambigu**, dan dibuang.
...
* Tiap pernyataan punya **satu angka** yang menandai posisinya di kontinum — inilah kalibrasinya.

* Pernyataan 4 punya rentang antar-kuartil yang **sangat lebar**: para juri tidak sepakat pernyataan itu ada di posisi mana. Pernyataan seperti ini dibuang, betapapun bagus kalimatnya.

* Pernyataan yang lolos **tersebar** dari ujung ke ujung. Ini disengaja, bukan kebetulan.
...
Kita sudah menentukan "tingkat kesulitan" tiap item **sebelum satu pun responden mengisinya**. Itu hal yang tidak bisa dilakukan CTT.
:::

## Cara responden menjawab dan cara menskornya

::: {.incremental}

* Responden hanya diminta **setuju atau tidak setuju** pada tiap pernyataan. Tidak ada derajat.
...
## Satu perubahan kecil yang mengubah segalanya
...
* Akibatnya, konsistensi internalnya sering **rendah** — dan itu **memang seharusnya begitu**.
...
* Pasangan pernyataan harus **disetarakan tingkat kemenarikannya** lebih dulu — dan itu perlu penelitian pendahuluan tersendiri.

* Kalau tidak disetarakan, format ini **tidak menyelesaikan apa pun**: responden akan tetap memilih yang terdengar lebih baik.

* Menyetarakan kemenarikan sama saja dengan mengkalibrasi item — sekali lagi, pekerjaan bergaya Thurstone.
...
* Karena totalnya dipaksa konstan, **korelasi antar-skala dipaksa menjadi negatif** — bahkan kalau konstruk yang sesungguhnya sama sekali tidak berhubungan.
...
::: {.callout-warning}
Angka-angka itu **muncul dari formatnya**, bukan dari psikologi respondennya.
:::
...
* **Perbandingan antar-orang jadi tidak sah.** Skor 8 pada skala ketelitian milik A tidak bisa langsung dibandingkan dengan skor 8 milik B.

* **Analisis faktor menjadi menyesatkan**, karena struktur korelasinya sudah dirusak lebih dulu oleh formatnya.
...
::: aside
Hicks (1970) merangkum persoalan ini secara menyeluruh.
:::
...
Kita membuka hari ini dengan Thurstone, dan menutupnya dengan Thurstone. Gagasan tahun 1920-an itu ternyata yang menyelamatkan format yang paling bermasalah di antara ketiganya.
:::
...
* ***Forced-choice*** — bisa dibuat, tetapi **jangan**. Analisis yang benar untuk data ipsatif berada di luar cakupan mata kuliah ini.
...
Karena Anda akan **menemui ketiganya** dalam praktik — terutama SJT dan *forced-choice*, yang banyak dipakai dalam asesmen dan seleksi kerja di Indonesia.

Yang perlu Anda bawa dari hari ini bukan kemampuan membuatnya, melainkan kemampuan **menilai apakah alat semacam itu dipakai secara benar**.
:::

## Tetapi satu hal tetap berlaku untuk Anda

::: {.incremental}

* Di Pertemuan 2 Anda sudah mengidentifikasi apakah konstruk kelompok Anda **rawan *social desirability***.

* Kalau jawabannya ya, Anda **tidak** perlu beralih ke *forced-choice*. Yang perlu Anda lakukan adalah:
  - menuliskannya sebagai keterbatasan di laporan,
  - memilih kalimat item yang tidak menghakimi,
  - dan menjamin anonimitas dengan sungguh-sungguh saat uji coba.
...
::: {.callout-tip}
Menyadari ancaman dan menuliskannya secara terbuka jauh lebih baik daripada memakai format rumit yang analisisnya tidak Anda kuasai.
:::

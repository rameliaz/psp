...
1. Apa yang harus dihasilkan kelompok Anda hari ini
2. **Tinjauan pustaka** yang berguna untuk penyusunan skala (dan yang tidak)
3. Cara menuliskan **definisi konstruk** yang bisa dipakai
4. **Batas konstruk**: apa yang tidak termasuk, dan *sibling construct*
5. ***Estimand***: besaran apa, pada siapa, dalam kondisi apa
6. Definisi konstruk dan **definisi operasional**
...
* Pertemuan hari ini hanya sedikit ceramah. Sebagian besar waktunya perlu dihabiskan untuk **kerja kelompok**.
...
# Langkah 1️⃣: tinjauan pustaka {background-color="#14497F" .center}
...
* Kalau Anda ingin melakukan riset yang lebih mendalam dan sistematis, coba ikuti [*template construct profiling*](https://docs.google.com/document/d/1JUtv6JsyaOPtBVC79j2Dk9bafFV1XEnH/edit) yang dibuat untuk MK yang lain (MK Literasi Data dan Penulisan Ilmiah, S2 Psikologi).
...
::: {.callout-tip}
#### Cara sederhananya
Buat tabel tiga kolom: **sumber**, **definisi (dikutip persis)**, **apa yang ditekankan**. Jangan diparafrasekan dulu. Perbedaan antar-definisi sering terletak pada pemilihan kata-kata tertentu.
:::
...
::: {.callout-note}
Ingat temuan [Fried (2017)](https://www.sciencedirect.com/science/article/pii/S016503271631312X) dari Pertemuan 1: tujuh skala depresi memuat 52 gejala berbeda. Perbedaan definisi sebenarnya adalah hal yang sering ditemui.
:::

# Langkah 2️⃣: menuliskan definisi konstruk {background-color="#14497F" .center}
...
::: aside
Diadaptasi dari [Podsakoff, MacKenzie, & Podsakoff (2016)](https://journals.sagepub.com/doi/full/10.1177/1094428115624965).
:::
...
## Kesalahan yang umum muncul

| Definisi | Masalahnya |
|---|---|
| "Kecemasan akademik adalah kecemasan yang dialami dalam konteks akademik." | **Melingkar/tautologis.** Kata yang didefinisikan dipakai lagi di dalam definisinya. |
...
* Contoh dari DeVellis: *locus of control*. [Rotter (1966)](https://psycnet.apa.org/record/2011-19211-001) menyusunnya secara umum. [Levenson (1973)](https://psycnet.apa.org/record/1974-09295-001) memisahkan tiga sumber kendali. [Wallston dkk. (1978)](https://journals.sagepub.com/doi/abs/10.1177/109019817800600107) mengkhususkannya pada konteks kesehatan. Versi berikutnya bahkan bisa dikhususkan lagi pada satu penyakit tertentu.
...
# Langkah 3️⃣: batas konstruk {background-color="#14497F" .center}
...
* ***Jingle fallacy*** — mengira dua hal sama karena **namanya sama**. Dua skala yang *supposedly* mengukur "resiliensi" bisa mengukur hal yang sangat berbeda. 
...
::: aside
Istilahnya berasal dari [Thorndike (1904)](https://psycnet.apa.org/fulltext/2005-12939-000-FRM.pdf) dan [Kelley (1927)](https://books.google.de/books?hl=id&lr=&id=Zd0jAAAAMAAJ&oi=fnd&pg=PR11&dq=Kelley+(1927)&ots=Va2Y3J0QCy&sig=PBvsPbC_bYibbEWZFNvq9x1QXsw&redir_esc=y).
:::

# Langkah 4️⃣: menetapkan estimand {background-color="#14497F" .center}

## Istilah yang dipinjam dari disiplin ilmu lain
...
* [Lundberg, Johnson, & Stewart (2021)](https://journals.sagepub.com/doi/abs/10.1177/00031224211004187) berargumen bahwa banyak penelitian melompati langkah ini: metodenya dipilih lebih dulu, lalu maknanya ditentukan belakangan.
...
1. **Apa nama atribut ukurnya?** Tingkat atribut pada seseorang? Posisi relatif dibanding orang lain? Ada atau tidaknya suatu kondisi?
...
# Langkah 5️⃣: definisi operasional {background-color="#14497F" .center}
...
2. **Satu konstruk *sibling*** dan apa bedanya dengan konstruk Anda.

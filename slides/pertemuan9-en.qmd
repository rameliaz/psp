...
1. What your group has to produce today
2. The kind of **literature review** that helps scale construction (and the kind that does not)
3. How to write a **construct definition** you can actually use
4. **Construct boundary**: what is excluded, and sibling constructs
5. **Estimand**: which quantity, in whom, under what conditions
6. From construct definition to **operational definition**
...
* If you want to go deeper and work more systematically, try the [*construct profiling template*](https://docs.google.com/document/d/1JUtv6JsyaOPtBVC79j2Dk9bafFV1XEnH/edit) built for another course (Data Literacy and Academic Writing, MA Psychology).
...
::: {.callout-note}
Recall [Fried's (2017)](https://www.sciencedirect.com/science/article/pii/S016503271631312X) finding from Session 1: seven depression scales contained 52 different symptoms. Disagreement between definitions is common.
:::
...
* DeVellis's example: locus of control. [Rotter (1966)](https://psycnet.apa.org/record/2011-19211-001) framed it generally. [Levenson (1973)](https://psycnet.apa.org/record/1974-09295-001) separated three loci. [Wallston et al. (1978)](https://journals.sagepub.com/doi/abs/10.1177/109019817800600107) made the outcomes health-specific. A later version can be narrowed to a single illness.
...
reach for a pilot next month?" The answer is usually much narrower, and that narrower answer is
the estimand they should use.

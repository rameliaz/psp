...
# Starting the practical half {background-color="#14497F" .center}
...
* With **6 to 10 raters**: I-CVI must be at least **0.78**.
...
::: aside
Haynes, Richard, & Kubany (1995); Rubio et al. (2003).
:::
...
::: {.callout-warning}
The table and decision record go into the final report and fill the **Item review / CVI** row of the assessment rubric.
:::

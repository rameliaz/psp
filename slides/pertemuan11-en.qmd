...
* In **Session 5**, students already ran a simple version of this as Thurstone judges: rating each statement, then discarding those they could not agree on.
...
::: {.callout-tip}
The procedure is the same. Only the criterion differs: not where a statement sits on a continuum, but **how relevant an item is to the construct**.
:::
...
* **Representatives of the target population** — not experts in the academic sense, but the best judges of whether the wording makes sense to prospective respondents.

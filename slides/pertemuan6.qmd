...
* Saya mengambil **5 item Extraversion** dan **5 item Neuroticism** dari data yang sama.

* Keduanya jelas mengukur konstruk yang **berbeda**. Skala gabungan ini secara substantif tidak masuk akal.

* Lalu saya memperlakukannya sebagai satu skala 10 item dan menghitung $\alpha$.
...
::: {.callout-note}
Pada set campuran tadi, *eigenvalue*-nya 3.53 dan 2.23, artinya keduanya besar. Inilah yang tidak bisa dilihat dari $\alpha = 0{.}616$.
:::

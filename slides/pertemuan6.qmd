...
* **McDonald's $\omega$ (versi asli, 1999)** — dihitung dari **satu** faktor laten (model *congeneric*).
  + Cocok digunakan kalau skala Anda memang unidimensional dan ini bisa dihitung dengan `jamovi`.

* [**Zinbarg, Revelle, Yovel, & Li (2005)**](https://link.springer.com/article/10.1007/s11336-003-0974-7) memperluasnya untuk skala dengan **satu faktor umum + beberapa faktor kelompok** ([model *bifactor*](http://www.personalityresearch.org/intelligence/structure.html)):
...
::: {.callout-warning appearance="simple"}
McDonald's ω di `jamovi` **bukan** $\omega_h$. Ia dihitung dari model satu-faktor saja, tanpa dekomposisi *bifactor* sehingga tidak bisa mendeteksi multidimensionalitas seperti yang barusan kita tunjukkan lewat `psych::omega()` di {{< fa brands r-project >}}.
:::

## Membandingkan koefisiennya {.smaller}
...
| $\omega$ *hierarchical* ($\omega_h$) | *bifactor*: 1 faktor umum + faktor kelompok | varians dari faktor **umum saja** | `psych::omega()` di {{< fa brands r-project >}} atau [*online calculator*](https://lensym.com/tools/mcdonalds-omega-calculator/) |
| $\omega$ *total* ($\omega_t$) | *bifactor*: 1 faktor umum + faktor kelompok | varians dari faktor umum **+ kelompok** | `psych::omega()` di {{< fa brands r-project >}}  atau [*online calculator*](https://lensym.com/tools/mcdonalds-omega-calculator/) |

: {tbl-colwidths="[18,27,27,28]"}
...
* Untuk itu Anda perlu melihat struktur korelasinya sendiri: *eigenvalue*, *scree plot*, dengan [analisis faktor](https://rameliaz.github.io/statistik-lanjut/slides/bagian-7.html#/title-slide).

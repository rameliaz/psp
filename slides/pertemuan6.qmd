...
* Seluruh isi pertemuan hari ini adalah tentang **cara mengestimasinya** dari sesuatu yang bisa kita amati: korelasi.
...
| Apakah item-itemnya **saling konsisten**? | Variasi antar-item | *Split-half*, $\alpha$, $\omega$ |
...
* **Jarak waktunya sangat menentukan.** Terlalu dekat, responden masih ingat jawabannya. Terlalu jauh, atributnya mungkin memang sudah berubah.
...
::: {.callout-note}
#### Untuk proyek Anda
*Test-retest* mengharuskan Anda menemui responden yang sama dua kali. Dengan jadwal semester ini, itu **tidak realistis**.

Yang perlu Anda catat: konsistensi internal yang akan Anda hitung **tidak menggantikan** informasi ini.
:::
...
Rumus ini mengasumsikan item tambahannya **setara** dengan item yang sudah ada. Menambah sepuluh item asal-asalan tidak akan memberi hasil seperti ini.
:::
...
* **Tambahan keuntungannya makin lama makin kecil**, sementara beban responden terus bertambah.
...
Jangan memperlakukan 0,70 sebagai batas lulus atau tidak lulus. **Sesuaikan dengan tujuan penggunaan skor Anda**: untuk penelitian kelompok, 0,70 memang memadai; untuk keputusan tentang individu, jauh dari cukup.
...
* $\omega$ tidak mensyaratkan asumsi tersebut. Perhitungannya memakai *loading* tiap item apa adanya.
...
Hitung **keduanya**. Kalau $\alpha$ dan $\omega$ berdekatan, Anda punya bukti tambahan bahwa struktur skala Anda cukup rapi. Kalau jaraknya jauh, itu **tanda bahwa ada yang perlu diperiksa**, bukan pilihan angka mana yang mau dipakai.
:::
...
* Untuk itu Anda perlu melihat struktur korelasinya sendiri: *eigenvalue*, *scree plot*, atau analisis faktor.
...
Ini adalah skala dengan $\alpha = 0{,}89$ — tergolong sangat baik menurut kriteria mana pun. Namun interval kepercayaan satu orang **selebar hampir 12 poin** pada skala yang rentangnya 10 sampai 50.
...
Jangan membuang item hanya karena angkanya. Kalau sebuah item **penting secara konseptual** untuk mendefinisikan konstruk Anda, membuangnya demi menaikkan α berarti Anda menukar validitas isi dengan koefisien yang lebih tinggi.
...
* **Bukti tentang dimensinya**, sekurang-kurangnya *eigenvalue* atau *scree plot*.
...
::: {.callout-tip}
Pertanyaan nomor 3 sangat menentukan, tetapi sering tidak ditanyakan.
:::

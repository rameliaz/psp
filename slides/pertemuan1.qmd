...
1. Apa sebenarnya yang kita lakukan ketika kita "mengukur konstruk psikologis"?
2. Sejarah singkat: pengukuran lahir dari kebutuhan sosial
3. Mengapa definisi "pengukuran" masih diperdebatkan sampai hari ini
4. Level pengukuran (Stevens) dan persoalan yang ditinggalkannya
5. Mengapa konstruk psikologis hanya bisa diukur secara **tidak langsung**
6. Skala, indeks, dan *emergent variable*
7. Apa akibat dari strategi pengukuran yang buruk?
...
* **Tugas akhir**: setiap kelompok (5 orang) akan **menyusun sebuah skala psikologis lengkap beserta manualnya**.
  + Tuliskan nama anggota kelompok Anda di [*spreadsheet* ini](https://docs.google.com/spreadsheets/d/1fTRKB_1MbFcJhqbmfC_gg8h5YDJlRPmh/edit?usp=sharing&ouid=100126014993390956583&rtpof=true&sd=true).
  + Akses ke *spreadsheet* akan dikunci setelah Pertemuan 3.

* **Paruh pertama (Pertemuan 1–7)**: membangun fondasi konseptualnya. Apa itu pengukuran, asumsi apa saja yang kita pakai (yang kadang-kadang implisit dan tidak disadari), apa itu variabel laten, bagaimana memilih format respons, apa artinya skor yang reliabel dan valid.
...
1. Seorang psikolog kesehatan ingin membedakan **apa yang pasien *inginkan*** dari **apa yang pasien *harapkan*** terjadi saat berkonsultasi dengan dokter. Skala yang tersedia saat ini mencampuradukkan keduanya. Ia bisa saja menyusun sendiri beberapa pertanyaan, tetapi apa jaminannya pertanyaan itu mengukur sesuatu yang sesungguhnya ia ingin ukur?
...
## Apa kesamaan dari 3️⃣ contoh tersebut?
...
Banyak kontributor awal psikometri bekerja dalam kerangka [*eugenics*](https://www.genome.gov/about-genomics/fact-sheets/Eugenics-and-Scientific-Racism). Teori dan analisis statistiknya masih kita pakai sampai sekarang, tetapi asumsi dan konsekuensi politis di baliknya (misalnya, sterilisasi paksa atau pembatasan reproduksi terhadap kelompok yang dianggap "inferior") **tidak boleh kita teruskan**.
:::
...
* [**S. S. Stevens**](https://www.jstor.org/stable/1671815) membantah: sifat aditif yang ketat **tidak diperlukan**. Orang bisa membuat penilaian rasio yang cukup konsisten, misalnya menilai satu suara dua kali lebih keras dari suara lain.
...
Yang utama adalah syarat **kopartisipansi**. Angka tidak boleh sekadar mengikuti aturan; strukturnya harus mencerminkan struktur atributnya. Kalau A punya atribut dua kali lebih banyak dari B, angkanya harus menunjukkan kualitas tersebut.
:::
...
# Mengapa psikologi mengukur objek ukur secara tidak langsung {background-color="#14497F" .center}
...
Yang dibandingkan adalah **status dan lama pernikahan** dengan pencapaian profesional, bukan dukungan sosial. Status pernikahan **mengabaikan** aspek penting dukungan sosial (misalnya kualitas dukungan yang dirasakan) dan **memasukkan** faktor yang tidak relevan (misalnya partisipan yang usianya belum cukup untuk menikah).
...
# Level pengukuran dan masalah yang meliputinya {background-color="#14497F" .center}
...
# Tidak semua kumpulan item bisa disebut skala {background-color="#14497F" .center}
...
# Konsekuensi dari pengukuran yang sembarangan {background-color="#14497F" .center}
...
Kalau datanya tidak bisa dimaknai, seberapa banyak pun data yang terkumpul jadi tidak ada gunanya. Meminta 300 orang mengisi instrumen yang tidak mungkin menghasilkan kesimpulan yang sahih adalah **persoalan etis**.
:::
...
* Asumsi bahwa partisipan **bisa** dan **mau** melaporkan kondisi internalnya secara akurat.

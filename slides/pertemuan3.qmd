...
# Apa itu variabel laten {background-color="#14497F" .center}
...
1. **Rata-rata *error* adalah nol**: $E(e) = 0$. Kalau pengukuran diulang tak terhingga kali, *error* saling meniadakan.
...
# Apa sebenarnya *true score* itu? {background-color="#14497F" .center}
...
::: aside
Angka **1** menandai *reference indicator*; huruf **a** menandai *loading* yang dibatasi agar sama; huruf **b** menandai varians *error* yang dibatasi agar sama.
:::
...
![](libs/icc-kesulitan.svg){.nostretch fig-align="center" width="70%"}
...
::: {.callout-note}
#### Perhatikan
Dua asumsi pertama itu persis asumsi nomor 4 dari Pertemuan 2. IRT **tidak menghapus** asumsi, melainkan mensyaratkannya lebih ketat dan memberi lebih banyak sebagai imbalannya.
:::

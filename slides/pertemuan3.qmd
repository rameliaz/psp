...
::: {.callout-tip}
Semakin besar porsi *noise* dalam skor Anda, semakin kecil semua korelasi yang Anda laporkan. 
:::
...
::: {.callout-note}
Inilah masalah yang ingin dipecahkan oleh *Item Response Theory*. Kita bahas di bagian terakhir.
:::

...
1. Building a **blueprint**: how many items per facet, and why that many
2. Item-writing principles, with faulty examples and their repairs
3. **Reverse-worded items**: what the evidence says, and when to use them
4. Settling the **response format** for the whole scale
5. Assembling the questionnaire: introduction, instructions, layout
6. Workshop and peer review between groups


# Construct specification becomes items {background-color="#14497F" .center}
...
Adding items past that point makes the scale perform worse, not just improve more slowly, and it increases participant burden.
:::
...
* If every item describes a severe level, participants at moderate levels will not be distinguished from one another.
...
* A double-barrelled item contains two ideas at once, so a participant who agrees with only one half has no correct answer available.
...
* A long item forces the participant to hold the start of the sentence in mind while reading the end.
...
::: {.callout-note}
DeVellis suggests a reading level around grades 5–7 for instruments used with the general population. With undergraduate participants you have a little more room, but short sentences are still better.
:::
...
* Items should also avoid making participants feel judged, particularly for constructs vulnerable to social desirability (Session 2).
...
* If a participant is simply agreeing, the pattern becomes visible: they endorse both the forward and the reversed items.
...
* Reversed items often **form their own factor** in factor analysis. What appears there is the wording.

:::

::: aside
Summarised from [Chyung, Barkin, & Shamsy (2018)](https://onlinelibrary.wiley.com/doi/abs/10.1002/pfi.21749); see also [Weijters, Baumgartner, & Schillewaert (2013)](https://psycnet.apa.org/record/2013-15543-001).
:::

## And participants stop noticing

::: {.incremental}

* Participant performance declines roughly **12 minutes** after starting a survey.
...
::: {.callout-note}
#### On the midpoint
[Chyung et al. (2017)](https://onlinelibrary.wiley.com/doi/abs/10.1002/pfi.21727) suggest reframing the question: not *"should there be a midpoint"* but *"when is a midpoint appropriate"*. A midpoint is appropriate when it is a genuine middle position, not somewhere to hedge.
...
* [Pershing & Pershing (2001)](https://onlinelibrary.wiley.com/doi/abs/10.1002/1532-1096%28200101/02%2912%3A1%3C73%3A%3AAID-HRDQ6%3E3.0.CO%3B2-7) examined 50 training-evaluation forms used at a well-regarded medical school.
...
A cluttered questionnaire reduces participant engagement, and that feeds directly into the reliability and validity of your scores.
:::
...
* **Number** items and use section headings so participants can see their progress.
...
Put them at the **end**, unless they are needed to screen participants at the start. Demographic questions at the beginning make some participants feel identified before they know what the questionnaire is about.
:::
...
The second: every item describes a severe level. Ask them to picture a participant at a moderate

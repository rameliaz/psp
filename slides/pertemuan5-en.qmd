...
* ***Forced-choice***: when participants must choose, and scores become **ipsative**
...
* Recall the sixth assumption from Session 2: participants are **willing** to report their state honestly.
...
We opened today with Thurstone, and we close with Thurstone. Thurstone's 1920s idea turns out to be the solution to this problem.
:::

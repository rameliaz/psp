...
* **Inside IRT.** IRT-based methods **share the same goal** as Thurstone scaling.
  + The difficulty parameter $b$ from Session 3 is essentially a Thurstone scale value, except that IRT estimates it from respondent data rather than from a judge panel.

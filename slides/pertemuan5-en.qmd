...
* What is realistic for your project this semester
...
::: {.callout-warning}
All three are conceptually attractive. All three are also **far harder to build** than Likert, and two of them break assumptions we established in Session 3. We will see exactly where.
:::
...
* ***Forced-choice*** — buildable, but **do not**. The correct analysis of ipsative data is outside this course.
...
## But one thing does apply to you

::: {.incremental}

* In Session 2 you identified whether your group's construct is **vulnerable to social desirability**.

* If it is, you do **not** need to switch to forced-choice. What you should do is:
  - state it as a limitation in your report,
  - write item stems that are not judgemental,
  - and guarantee anonymity properly during the pilot.
...
::: {.callout-tip}
Recognising a threat and stating it openly is far better than adopting a complex format whose analysis you cannot carry out.
:::

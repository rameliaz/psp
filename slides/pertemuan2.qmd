...
1. Kenapa asumsi perlu diperiksa
2. **Asumsi 1**: atribut psikologis bervariasi secara kuantitatif
3. **Asumsi 2**: atributnya terdistribusi normal
4. **Asumsi 3**: atributnya *continuous*, bukan kategorikal
5. **Asumsi 4**: semua item mengukur satu hal yang sama
6. **Asumsi 5**: item bekerja dengan cara yang sama untuk semua kelompok
7. **Asumsi 6**: partisipan **bisa** dan **mau** melaporkan kondisi internalnya
8. Apa yang bisa kita lakukan terhadap asumsi-asumsi ini

...
* **Asumsi 6**: partisipan **bisa** dan **mau** melaporkan kondisi internalnya
...
# Kilas balik Pertemuan 1 {background-color="#14497F" .center}
...
* Karena asumsi-asumsi ini biasanya **tidak dilaporkan secara eksplisit di laporan penelitian**, hanya hasil penelitiannya saja.
...
| 6 | partisipan **bisa dan mau** menjawab secara akurat | Sebagian |
...
* **Galton** kemudian memakainya untuk sifat-sifat psikologis, dan sejak itu normalitas menjadi semacam asumsi otomatis dalam psikometri.
  + Inilah yang menjustifikasi pandangan [*eugenics* yang amat rasis](https://www.genome.gov/about-genomics/fact-sheets/Eugenics-and-Scientific-Racism).
...
* Item yang tersisa adalah item yang **membelah partisipan di tengah**.
...
Data IPIP *Big Five* (`data/data.csv` di repositori mata kuliah ini), 50 item, skala 1–5, **n = 19.719** partisipan (jumlah baris mentah; Pertemuan 6 memakai n = 19.718 setelah *listwise deletion*).
...
* Dan sebarannya tetap tidak persis normal: bentuknya lebih datar, dengan partisipan yang lebih menyebar di rentang tengah daripada yang diperkirakan kurva normal.
...
* Akibatnya, partisipan dari budaya yang punya standar ketelitian tinggi bisa memberi skor diri **lebih rendah**, meskipun perilakunya justru lebih sesuai dengan konstruk itu.
...
# Asumsi 6: partisipan bisa dan mau menjawab akurat {background-color="#14497F" .center}
...
1. partisipan **mampu** mengamati kondisi internalnya dan melaporkannya.

2. partisipan **bersedia** melaporkannya apa adanya.

:::

. . .

Kedua asumsi ini bisa gagal, masing-masing dengan cara yang berbeda.
...
* partisipan cenderung menjawab dengan cara yang **membuat dirinya tampak baik**: kadang sadar, kadang tidak.
...
Kalau konstruk yang Anda pilih punya "jawaban yang diterima" secara sosial, sebaran skor Anda akan **menumpuk di satu ujung** (e.g., [*ceiling* atau *floor effect*](https://matilda.fss.uu.nl/articles/floor-ceiling-effects.html)). Anda akan kesulitan membedakan partisipan satu sama lain karena data Anda variansnya rendah. 
:::
...
Tetapi item terbalik punya masalahnya sendiri: sebagian partisipan salah membacanya, dan seringkali item-item terbalik justru mengelompok sendiri dalam analisis faktor seolah-olah membentuk dimensi terpisah. Kita bahas plus-minusnya di Pertemuan 10.
:::
...
* Sebagian partisipan mengisi tanpa membaca, terutama pada kuesioner panjang, daring, dan tanpa insentif.

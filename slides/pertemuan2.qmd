...
::: {.callout-note}
#### Benang merahnya
Semua asumsi ini punya kesamaan: **ada asumsi-asumsi yang kita anggap benar tanpa pernah kita periksa**.
:::

## Kenapa satu pertemuan penuh hanya untuk membahas asumsi?
...
* Asumsi adalah **pegangan yang harus kita punya** agar bisa mengukur yang apa ingin kita ukur.

* Yang bermasalah bukan ada atau tidaknya asumsi, melainkan **asumsi yang tidak disadari dan tidak pernah dideklarasikan**.
...
"Saya mengasumsikan atribut ini *continuous*, dan berikut alasannya" adalah pernyataan ilmiah.

"Saya menjumlahkan itemnya karena begitulah caranya" bukan pernyataan ilmiah.
:::
...
::: {.callout-note}
#### Tetapi...
Ini persis yang membedakan *Classical Test Theory* dari *Item Response Theory*. IRT memungkinkan tiap item punya "tingkat kesulitan" dan "daya diskriminasi" sendiri. Kita bahas sekilas di Pertemuan 3.

Mata kuliah ini memakai CTT, jadi *unit weighting* adalah asumsi yang akan Anda pakai. Yang penting, Anda tahu bahwa asumsi ini yang dipakai.
:::
...
* Implikasinya: kurva normal berpindah dari **model tentang *error*** menjadi **model tentang manusia**.
...
* Pertanyaannya bukan "mana yang lebih praktis", melainkan **mana yang benar secara teoretis untuk konstruk ini**.

* Ini pertanyaan **empiris**, dan ada metodenya: [*taxometrics*, dikembangkan Paul Meehl](https://meehl.umn.edu/sites/meehl.umn.edu/files/files/122txmethodschapter.pdf).
...
Ini persis ketegangan yang kita lihat pada DSM: sistem klasifikasi yang kategoris, dipakai untuk konstruk yang buktinya menunjukkan kontinum. Itu juga yang melatarbelakangi *project* [Research Domain Criteria (RDoC)](https://www.nimh.nih.gov/research/research-funded-by-nimh/rdoc).
:::
...
* Sebagian besar skala psikologis — termasuk yang akan Anda susun — mengasumsikan **dimensional**. Itu asumsi yang umum, tapi tetap asumsi yang harus diuji.
...
Skor 40 bisa berarti "hati tenang, ekonomi sulit" atau "ekonomi mapan, hati gelisah". Angkanya sama, kondisi orangnya sangat berbeda.
:::
...
* Kita mengasumsikan bahwa item yang sama **artinya sama** bagi laki-laki dan perempuan, bagi mahasiswa dan pekerja, bagi orang Jawa dan orang Papua.
...
::: {.callout-note}
Uji formalnya membutuhkan analisis faktor dan sampel besar, jadi kita tidak akan mempelajarinya di mata kuliah ini. Yang perlu Anda punya sekarang adalah **kesadaran bahwa asumsi ini Anda gunakan**.
:::
...
* **[Heine, Lehman, Peng, & Greenholtz (2002)](https://psycnet.apa.org/record/2002-02942-003)** menunjukkan masalah serius pada perbandingan skala Likert antar-budaya.
...
* Kalau kelompok Anda memilih mengadaptasi skala yang sudah ada, ini bukan masalah penerjemahan, tetapi masalah psikometrik.
...
* Ketika ditanya alasan, mereka tetap menjawab, tetapi jawabannya sering berupa **teori awam yang masuk akal**, bukan laporan atas proses psikologis yang sesungguhnya terjadi.
...
* Ini bukan berarti "*pengukuran psikologis tidak ada gunanya*."

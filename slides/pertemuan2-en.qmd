...
1. Why assumptions need checking
2. **Assumption 1**: psychological attributes vary quantitatively
3. **Assumption 2**: the attribute is normally distributed
4. **Assumption 3**: the attribute is continuous, not categorical
5. **Assumption 4**: all items measure the same single thing
6. **Assumption 5**: items work the same way for every group
7. **Assumption 6**: participants can and will report their internal states
8. What we can actually do about all of this
